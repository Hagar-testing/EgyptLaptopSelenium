...
public class CheckoutPageConstants {
    ...
    // Phone input locator
    public static final String PHONE_INPUT_ID = "litecheckout_phone";

    // Accept terms checkbox locator
    public static final String ACCEPT_TERMS_CHECKBOX_NAME = "accept_terms";

    // Address input locator
    public static final String ADDRESS_INPUT_ID = "litecheckout_s_address";
